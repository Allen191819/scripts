...
print_vol() {
    ...
    if [ "$volunmuted" = true ]; then vol_text="--"; vol_icon="婢";
    elif [ "$vol_text" -eq 0  ]; then vol_text="--"; vol_icon="婢";
...
print_light(){
    ...
    if [ "$light_text" -eq 0  ]; then   light_icon="";
    elif [ "$light_text" -lt 10 ]; then light_icon=""; light_text=0$light_text;
    elif [ "$light_text" -le 20 ]; then light_icon="";
    elif [ "$light_text" -le 30 ]; then light_icon="";
    elif [ "$light_text" -le 40 ]; then light_icon="";
    elif [ "$light_text" -le 50 ]; then light_icon="";
    elif [ "$light_text" -le 60 ]; then light_icon="";
    elif [ "$light_text" -le 70 ]; then light_icon="";
    elif [ "$light_text" -le 80 ]; then light_icon="";
    elif [ "$light_text" -le 90 ]; then light_icon="";
    else light_icon=""; fi
